      ...
      <div>
        ...
        <div id="container">
          ...
          <div className="content">
            ...
            <h2>none</h2>
            <p>
              Chú ý rằng display còn có thể thiết lập là <code>none</code>. Một số phần tử đặc biệt như <code>script</code> có giá trị mặc định này. Trên thực tế, người ta hay dùng JavaScript để ẩn hoặc hiện một đối tượng nào đó, bằng việc thay đổi giá trị của display, thay vì thực sự xóa hoặc tạo lại một phần tử HTML nào đấy.
            </p>
            <p>
              Chú ý nữa là thuộc tính display khác với thuộc tính <code>visibility</code>. Thiết lập <code>display</code> thành <code>none</code> sẽ render trang web theo kiểu element HTML không tồn tại. Trong khi đó, khi thiết lập <code>visibility: hidden;</code>, phần tử HTML đó sẽ bị ẩn, nhưng nó vẫn chiếm không gian của trang, như lúc nó hiển thị vậy.
            </p>
            <div style={{ display: "none" }}>You found me!</div>
            <h2>Các giá trị khác của thuộc tính display</h2>
            <p>
              Có khá nhiều các giá trị khác cho thuộc tính <code>display </code>, chẳng hạn như: <code>list-item</code> và <code>table</code>.{" "}
              <a href="https://developer.mozilla.org/en-US/docs/CSS/display">
                Xem thêm tại đây
              </a>
              . Chúng ta sẽ thảo luận về <code>inline-block</code> và <code>flex</code> sau này. Hiện nay, xu thế mới nhất là dùng <code>grid</code>.
            </p>
            <h2>thêm tí hành tỏi: </h2>
            <p>
              Chú ý rằng tất cả các thẻ đều có giá trị display mặc định, nhưng chúng ta <em>luôn luôn</em> ghi đè được. Tất nhiên, sẽ khá là dzô dziên nếu ép kiểu của div sang dạng inline, nhuwg trong những tình huống cụ thể, chúng ta có thể linh hoạt thiết lập. Mộ tình huống khá quen thuộc là chúng ta thiết lập thẻ <code>li</code> thành dạng inline cho các elements của menu dạng thẳng đứng.
            </p>
          </div>
